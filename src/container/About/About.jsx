  ...
  return (
    <>
      ...
      <p className="p-text" style={{ marginTop: '1rem' }}>
        I live in Lagos Nigeria, I am a solution-oriented website
        designer/developer, I have deep background in basic web development
        (HTML, CSS, and Javascript) I rejuvenated my passion for website
        development through constant and consistent practice. I possess great
        experience and skills in web design & development. My primary focus is
        on creating quality websites using clean code and well-structured
